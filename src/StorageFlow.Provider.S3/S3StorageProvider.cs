...
/// <summary>
/// AWS S3 implementation of <see cref="IStorageProvider"/>.
/// All Amazon SDK exceptions are caught and re-thrown as <see cref="StorageProviderException"/>.
/// </summary>
public sealed class S3StorageProvider : IStorageProvider
{
    ...
    /// <param name="client">A configured <see cref="IAmazonS3"/> client instance.</param>
    /// <param name="useHttpsForPresignedUrls">
    /// Whether generated presigned URLs use HTTPS. Disable only for an HTTP custom endpoint.
    /// </param>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw ProviderFailure("S3 upload", ex);
        }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw ProviderFailure("S3 download", ex, bucket, objectKey);
        }
        catch (AmazonS3Exception ex)
        {
            throw ProviderFailure("S3 download", ex, bucket, objectKey);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw ProviderFailure("S3 delete", ex, bucket, objectKey);
        }
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw ProviderFailure("S3 exists check", ex, bucket, objectKey);
        }
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw ProviderFailure("S3 presigned URL generation", ex, bucket, objectKey);
        }
    }
